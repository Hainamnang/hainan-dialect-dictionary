...
function ArticleDetail({
  ...
  return (
    <div
      ...
      className="col-span-full scroll-mt-24 rounded-lg border border-stone-200 bg-white p-4 xl:order-last"
    >
      ...
      >
        {renderDictionaryLinks(article.content || "")}
      </div>
                    ...
                    <div className="flex h-full flex-col gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-3 inline-flex rounded-md bg-purple-700 px-4 py-2 text-sm font-bold text-white">
                          {isSelected ? "ปิดข้อความ" : "เปิดอ่านข้อความ"}
                        </div>
                      </div>
                    </div>
                  </button>
